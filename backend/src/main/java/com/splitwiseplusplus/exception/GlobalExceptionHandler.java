...
import com.splitwiseplusplus.dto.ApiResponse;
...
/**
 * Global Exception Handler — translates exceptions to structured API error responses.
 */
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiResponse<Void>> handleMaxUploadSize(MaxUploadSizeExceededException ex) {
        return ResponseEntity.status(HttpStatus.PAYLOAD_TOO_LARGE)
                .body(ApiResponse.error("File size exceeds the maximum allowed limit (10MB)", 413));
    }
